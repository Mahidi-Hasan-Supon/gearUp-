...
const patchUserStatus = catchAsync(async(req:Request ,res:Response , next:NextFunction)=>{
    ...
    const result = await adminService.patchUserStatus()
...
const getGear = catchAsync(async(req:Request ,res:Response , next:NextFunction)=>{
...
const getRental = catchAsync(async(req:Request ,res:Response , next:NextFunction)=>{
